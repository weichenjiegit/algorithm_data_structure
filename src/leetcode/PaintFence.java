...
public class PaintFence {
	 ...
	 * 
	 * 1. the last two posts have the same color, the number of ways to paint in this case is
	 * sameColorCounts.
	 * 
	 * 2. the last two posts have different colors, and the number of ways in this case is
	 * diffColorCounts.
	 * 
	 ...
	 * or different color. If we use different color, there're k-1 options, and the outcomes should
