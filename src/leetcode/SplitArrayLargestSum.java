...
public class SplitArrayLargestSum {
	 ...
	 * 
	 * 2. Use binary search to approach the correct answer. We have l = max number of array; r = sum
	 * of all numbers in the array;Every time we do mid = (l + r) / 2;
	 * 
	 ...
	 * or we cannot.
	 * 
	 * If we can, it means that the mid value we pick is too small because we've already tried our
	 * best to make sure each part holds as many non-negative numbers as we can but we still have
	 * numbers left. So, it is impossible to cut the array into m parts and make sure each parts is
