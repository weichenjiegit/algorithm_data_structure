...
public class DesignSnakeGame {
	public class SnakeGame {
		 ...
		 *            - screen height
		 * @param food
		 *            - A list of food positions E.g food = [[1,1], [1,0]] means the first food is
		 ...
		 * @return The game's score after the move. Return -1 if game over. Game over when snake
		 *         crosses the screen boundary or bites its body.
		 */
		public int move(String direction) {
			...
			set.remove(body.peekLast()); // new head is legal to be in old tail's position, remove
			                             // from set temporarily
